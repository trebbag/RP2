        ...
        <div className={`flex items-center ${compact ? "gap-2" : "gap-4"} ${compact ? "flex-col sm:flex-row" : ""}`}>
          <div className="flex items-center gap-2">
            ...
            {appointment.priority === "high" && (
              <div
                className={`absolute ${compact ? "-top-0.5 -right-0.5 w-3 h-3" : "-top-1 -right-1 w-4 h-4"} bg-red-500 rounded-full border-2 border-white`}
              />
            )}
          </div>
          ...
          <div className="flex items-center gap-2 ml-auto">
            {!appointment.fileUpToDate && (
              <Button variant="outline" size="sm" onClick={() => onUploadChart?.(appointment.patientId)}>
              ...
              <CardContent className="space-y-2">
                {timeSlots.map((time) => {
                  ...
                  return (
                    <div
                      key={time}
                      className={`p-2 rounded border ${hasAppointment ? "bg-blue-50 border-blue-200" : "bg-slate-50 border-slate-200"}`}
                    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => setCalendarView(calendarView === "grid" ? "list" : "grid")}
            >
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setSettings({ ...settings, defaultView: value as "day" | "week" | "month" })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
