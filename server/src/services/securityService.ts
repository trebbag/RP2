...
function generateTotp(secret: string, timeMs: number, stepSeconds = 30, digits = 6): string {
...
export function buildOtpAuthUrl(input: { email: string; secret: string }): string {
...
export function consumeBackupCode(code: string, hashedCodes: string[]): { valid: boolean; remainingHashed: string[] } {
