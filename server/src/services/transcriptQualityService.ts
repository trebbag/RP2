...
function getAllowedSpeakers(): Set<string> {
...
export function buildTranscriptQualityReport(segments: TranscriptQualitySegment[]): TranscriptQualityReport {
  ...
  const issues: TranscriptQualityReport["issues"] = []
