...
export DATABASE_ADMIN_URL="${DATABASE_ADMIN_URL:-postgresql://postgres:postgres@localhost:${POSTGRES_PORT}/revenuepilot}"
export DATABASE_URL="${DATABASE_URL:-postgresql://rp2_app:rp2_app@localhost:${POSTGRES_PORT}/revenuepilot}"
